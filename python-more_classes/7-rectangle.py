...
class Rectangle:
    """Defines rectangle w width,height,instance counting,n custom symbols."""

    number_of_instances = 0  # Compteur d'instances
    print_symbol = "#"  # Symbole pour l'affichage
    ...
    def __str__(self):
        """Ret string represent of the rectangle with `print_symbol`."""
        if self.__width == 0 or self.__height == 0:
            return ""
